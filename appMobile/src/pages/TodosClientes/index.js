...
export default function TodosCliente() {
    ...
    const navegaEditarCliente = (pId, pNome, pDataNasc, pCpf) => {
        navigation.navigate('EditarCliente', { id: pId, nome: pNome, dataNasc: pDataNasc, Cpf: pCpf });
    };
    ...
    */
    ...
    let listItemView = (item) => {
        return (
            ...
            <View
                key={item.id}
                style={{ backgroundColor: 'white', marginBottom: 30, padding: 15, borderRadius: 10, shadowColor: 'black', elevation: 14 }}>
                ...
                <Text style={styles.textbottom}>{item.dataNasc}</Text>
                ...
                <View style={[styles.container, styles.alignVH]}>
                    ...
                    <TouchableOpacity
                        onPress={() => {
                            navegaEditarCliente(item.id, item.nome,item.dataNasc, item.Cpf);
                            // setFlatListItems([]);
                        }}>
                        <FontAwesome5 name="edit" color='black' size={24} />
                    </TouchableOpacity>
                </View>
            </View>
