    ...
    <SafeAreaView style={styles.container}>
      ...
      {cliente[0] &&
        <View style={{ width: '80%' }}>
          ...
          <TextInput style={[styles.inputText, { width: '20%' }]} value={cliente[0]?.dataNasc.toString()} readOnly></TextInput>
          <Text>Cpf do cliente:</Text>
          <TextInput style={[styles.inputText, { width: '20%' }]} value={cliente[0]?.Cpf.toString()} readOnly></TextInput>
        </View>
      }
